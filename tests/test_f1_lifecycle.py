...
class TestSnapshotLifecycle:
    ...
    def setup_teardown(self, runner, validator, mutator, config):
        """
    ...
    def test_full_lifecycle_parity(self):
        ...
        self.validator.assert_results_match(hdfs_res, obs_res, feature_tag="allowSnapshot")
        ...
        self.validator.assert_results_match(res_h, res_o, feature_tag="createSnapshot")
        ...
        # 断言 2：抛出的异常拦截信息必须一致
        self.validator.assert_results_match(res_h, res_o, feature_tag="readonly_block")
    ...
    def test_f1_02_rename_snapshot(self):
        ...
        self.validator.assert_results_match(res_h, res_o, feature_tag="renameSnapshot")
    ...
    def test_f1_03_delete_snapshot(self):
        ...
        self.validator.assert_results_match(res_h, res_o, feature_tag="deleteSnapshot")
    ...
    def test_f1_05_disallow_with_snapshots_fails(self):
        ...
        self.validator.assert_results_match(res_h, res_o, feature_tag="disallowSnapshot", strict_error_match=True)
    ...
    def test_f1_07_allow_idempotency(self):
        ...
        self.validator.assert_results_match(res_h, res_o, feature_tag="allowSnapshot")
        assert res_h.returncode == 0
    ...
    def test_f1_06_disallow_without_snapshots(self):
        ...
        self.sandbox.allow_snapshot()
        res_h, res_o = self.sandbox.disallow_snapshot()
        self.validator.assert_results_match(res_h, res_o, feature_tag="disallowSnapshot")
        assert res_h.returncode == 0
    ...
    def test_f1_08_create_snapshot_unauthorized(self):
        ...
        assert res_h.returncode != 0
        assert res_o.returncode != 0
        self.validator.assert_results_match(res_h, res_o, feature_tag="createSnapshot", strict_error_match=True)
